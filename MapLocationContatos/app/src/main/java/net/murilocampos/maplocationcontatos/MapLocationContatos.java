package net.murilocampos.maplocationcontatos;
...
public class MapLocationContatos extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new Button.OnClickListener() {
            ...
            // Chamado Quando o usuário aperta o botão de Encontrar Contatos
            @Override
